  ...
  return (
    <>
      ...
      <div style={{ width: "100vw", height: "80vh" }}>
        <img src="/Home.avif" alt="img" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
        {/* <Image src={"/HomeImg.jpeg"} alt="heroimg" width={1000} height={1000} quality={100} objectFit="contain" /> */}
      </div>

      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Beyond Code, Beyond Borders: Alien Essentials for Dev Innovators to Shop.</h1>
          ...
          <div className="flex flex-wrap -m-4">
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-6 rounded-lg">
                ...
                <h2 className="text-lg text-gray-900 fostrokeWidthclassnt-medium title-font mb-2">Neptune</h2>
                <p className="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
